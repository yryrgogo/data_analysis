...
# feature selection
feim_result = pd.read_csv('../feature_enginering/.csv')
...
def prediction(feature_list):
    ...
    submit_score['prediction_score'] = submit_pred
    #  submit_score['prediction_score_2'] = submit_pred

    submit_score.to_csv('../output/{}_2018_ncaa_score_pred_for_submit.csv'.format(start_time), index=False)
